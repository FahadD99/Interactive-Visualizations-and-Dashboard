// Declare the data variable Thank you for your help with this homework Dan
...
d3.json(data).then((data) => {
    ...
    // Using a for-loop, create a function to input text into the subject dropdown Thank you Dan, for the for-loop idea
    names.forEach((name) => {
